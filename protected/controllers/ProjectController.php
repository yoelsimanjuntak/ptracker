...
class ProjectController extends Controller
{
	...
	public function actionView($id)
	{
            ...
            $tasks = new CActiveDataProvider('Task', array(
                'criteria'=>array('condition'=>'project_id='.$id.' AND deleted=0 AND has_parent=0'),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Project']))
		{
			...
			if($model->save())
				$this->redirect(array('myProjects'));
		}
        ...
        public function actionMyProjects()
        {
            ...
            $dataProvider = new CActiveDataProvider('Project', array(
                'criteria' => array(
                    'condition' => 'creator_id='.Yii::app()->user->id.' AND deleted=0',
                ),
                'sort'=>array('defaultOrder'=>'start_date ASC',
                )
            ));
	...
	{
                $dataProvider = new CActiveDataProvider('Project', array(
                    'criteria' => array('condition' => 'deleted=0'),
                    'sort' => array('defaultOrder'=>'start_date ASC')
                ));
        ...
        public function actionTimetable($id) {
            $tasks = Task::model()->findAll(array('condition'=>'project_id='.$id.' AND deleted=0'));
            $this->renderPartial('timetable',array('tasks'=>$tasks),false,false);
        }
