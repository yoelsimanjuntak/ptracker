...
class Account extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, username, password, timestamp', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'tasks' => array(self::HAS_MANY, 'Task', 'creator_id'),
			'taskAssignments' => array(self::HAS_MANY, 'TaskAssignment', 'member_id'),
		);
	}
